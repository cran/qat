qat_save_block_distribution_2d <-
function(resultlist_part, baseunit="") {
## functionality: save distribution
## author: André Düsterhus
## date: 23.10.2012
## version: A0.1
## input: resultlist part from qat_analyse_block_distribution_2d, optional: baseunit
## output: savelist
	method <- "dist_block"
	meanings <- NULL
	...
	dimension <- list(first_moment=list(blockdist_vec=blocknum, mes_vec2=NaN), second_moment=list(blockdist_vec=blocknum, mes_vec2=NaN), third_moment=list(blockdist_vec=blocknum, mes_vec2=NaN), fourth_moment=list(blockdist_vec=blocknum, mes_vec2=NaN), standard_deviation=list(blockdist_vec=blocknum, mes_vec2=NaN), skewness=list(blockdist_vec=blocknum, mes_vec2=NaN), kurtosis=list(blockdist_vec=blocknum, mes_vec2=NaN), median=list(blockdist_vec=blocknum, mes_vec2=NaN), p5_quantile=list(blockdist_vec=blocknum, mes_vec2=NaN), p95_quantile=list(blockdist_vec=blocknum, mes_vec2=NaN), p25_quantile=list(blockdist_vec=blocknum, mes_vec2=NaN), p75_quantile=list(blockdist_vec=blocknum, mes_vec2=NaN))
