qat_save_slide_distribution_1d <-
...
## output: savelist
	...
	dimension <- list(slidedist_vec=blocknum, slidedist_vec=blocknum, slidedist_vec=blocknum, slidedist_vec=blocknum, slidedist_vec=blocknum, slidedist_vec=blocknum, slidedist_vec=blocknum, slidedist_vec=blocknum, slidedist_vec=blocknum, slidedist_vec=blocknum, slidedist_vec=blocknum, slidedist_vec=blocknum)
